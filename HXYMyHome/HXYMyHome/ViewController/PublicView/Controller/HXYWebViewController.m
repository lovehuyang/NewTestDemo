...
#import "HXYWebViewProgressView.h"
@interface HXYWebViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) WKWebView *webView;
@property (nonatomic,strong) HXYWebViewProgressView *webProgressView;
@end

@implementation HXYWebViewController
...
- (void)viewDidLoad {
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:self.adModel.adContentUrl]];
    [self.webView loadRequest:request];
    [self.webView setNeedsUpdateConstraints];
    
    CGFloat progressBarHeight = 2.f;
    _webProgressView = [[HXYWebViewProgressView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, progressBarHeight)];
